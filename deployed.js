...
await lib.discord.channels['@0.2.0'].messages.create({
  ...
  embeds: [{
    ...
    "description": [
      ...
      `\`${process.env.PREFIX}leave\`: Disconnect the bot from the voice channel`,
      ...
      `\`${process.env.PREFIX}addqueue <query>\`: Add a track to the queue`,
